  ...
  return (
    ...
    >
      ...
      <div className="py-16 w-full text-center">
        ...
        {/* <BlurFade inView delay={0.4}> */}
          <AnimatedGradientText>
            <h1
              className={cn(
                `inline leading-[2.9rem]! lg:leading-[5.3rem]! animate-gradient whitespace-nowrap text-4xl lg:text-6xl font-bold bg-linear-to-r from-[#ffaa40] via-[#2563eb] to-[#ffaa40] bg-size-[var(--bg-size)_100%] bg-clip-text text-transparent`
              )}
            >
              {t("name")}
            </h1>
        ...
        {/* <BlurFade inView delay={0.7}> */}
          <h2 className="text-3xl font-poppins md:text-5xl lg:text-7xl font-medium whitespace-nowrap max-sm:mt-2 bg-linear-to-br from-black-100 dark:from-white from-30% via-[#d5d8f6] via-80% to-[#eee4f0] dark:to-[#fdf7fe] bg-clip-text text-transparent">
            Front-end Developer
          </h2>
        {/* </BlurFade> */}
        <TextGenerateEffect
          ...
          {/* <BlurFade inView delay={1.1}> */}
            <Link href="https://github.com/OsamaHIma" target="_blank">
              <InteractiveHoverButton
                className="py-3 w-80 md:ltr:w-64"
                text={t("checkGithub")}
              />
            </Link>
          {/* </BlurFade> */}
      ...
      >
        ...
        <div className="relative flex size-[40px] md:size-[55px] items-center justify-center bg-blue-500 rounded-full">
          <svg
            height="682pt"
            viewBox="-23 -21 682 682.66669"
            width="682pt"
            xmlns="http://www.w3.org/2000/svg"
            className="h-[23px] sm:h-[30px] relative bottom-px"
          >
            <path
