    ...
    <section>
      <div className="container mx-auto min-h-screen px-6 py-12 lg:flex lg:items-center lg:gap-12">
        <div className="wf-ull lg:w-1/2">
          <p className="text-sm font-medium text-theme-color">
            Error Code: 500
          </p>
          ...
          <div className="mt-6 flex items-center gap-x-3">
            ...
            <Link
              href="/"
              className="w-1/2 shrink-0 rounded-lg bg-theme-color px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 sm:w-auto hover:opacity-75"
            >
              Take me home
            </Link>
          </div>
