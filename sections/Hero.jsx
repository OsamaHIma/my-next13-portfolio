  ...
  return (
    <section className="mt-36 mx-16 flex flex-col items-start gap-4 justify-center min-h-[60vh] paddings">
      <h1 className="text-theme-color font-medium text-2xl whitespace-nowrap">
        <Translate translations={{ ar: "السلام عليكم أنا" }}>
      ...
      <p className="font-semibold text-gray-700 dark:text-gray-300 leading-8 mt-2 text-[18px]">
        <Translate
          translations={{
            ar: "مطور واجهات أمامية ماهر ولدي خبرة واسعة في JavaScript ، وأنا متخصص في أطر عمل مثل React.js و Next.js.",
          }}
        >
          A skilled front-end developer with extensive experience in JavaScript,
          and I specialize in frameworks like React.js and Next.js.
        </Translate>
        <br />{" "}
        <Translate>
      ...
      <Link href="https://github.com/OsamaHIma" target="_blank">
        <Button className="whitespace-nowrap w-fit border-2 border-solid bg-transparent border-theme-color my-4 hover:bg-theme-color !text-theme-color hover:!text-slate-50">
