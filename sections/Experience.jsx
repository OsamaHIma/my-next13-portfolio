    ...
    <section className={`${styles.paddingX}`} id="experience">
      ...
      <div className="px-6 py-4">
        ...
        <ul className="list-disc list-inside mb-8">
          ...
          <li className="text-gray-600 dark:text-gray-300 font-medium text-lg mb-4">
            Worked with APIs to integrate third-party services, such as payment
            gateways and social media platforms, into web applications
          </li>
          <li className="text-gray-600 dark:text-gray-300 font-medium text-lg mb-4">
            Reviewed code written by interns, providing actionable feedback and
            suggestions for improvement to ensure code quality and
            maintainability
          </li>
          <li className="text-gray-600 dark:text-gray-300 font-medium text-lg mb-4">
            Troubleshot and debugged issues in web applications, both
            independently and in collaboration with other developers, to ensure
            optimal user experience
          </li>
          <li className="text-gray-600 dark:text-gray-300 font-medium text-lg mb-4">
            Developed and implemented responsive design principles to ensure web
            applications were accessible on a range of devices, including
            desktop and mobile
          </li>
          <li className="text-gray-600 dark:text-gray-300 font-medium text-lg mb-4">
